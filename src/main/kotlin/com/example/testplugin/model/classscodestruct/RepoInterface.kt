...
import com.example.testplugin.model.builder.RepoInterfaceCodeBuilder
 ...
 */
data class RepoInterface(
    override val name: String,
    val properties: List<Property> = listOf(),
    override val modifiable: Boolean = true,
    val comments: String = "",
    override val codeBuilder: RepoInterfaceCodeBuilder = RepoInterfaceCodeBuilder(),
    ...
    override fun replaceReferencedClasses(replaceRule: Map<KotlinClass, KotlinClass>): RepoInterface {
