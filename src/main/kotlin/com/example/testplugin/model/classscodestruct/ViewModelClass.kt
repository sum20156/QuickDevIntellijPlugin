...
import com.example.testplugin.model.builder.ViewModelClassCodeBuilder
 ...
 */
data class ViewModelClass(
    override val name: String,
    val properties: List<Property> = listOf(),
    override val modifiable: Boolean = true,
    val comments: String = "",
    override val codeBuilder: ViewModelClassCodeBuilder = ViewModelClassCodeBuilder(),
    ...
    override fun replaceReferencedClasses(replaceRule: Map<KotlinClass, KotlinClass>): ViewModelClass {
