...
import com.example.testplugin.model.builder.RepoImplClassCodeBuilder
 ...
 */
data class RepoImplClass(
    override val name: String,
    val properties: List<Property> = listOf(),
    override val modifiable: Boolean = true,
    val comments: String = "",
    val parentClass: KotlinClass,
    override val codeBuilder: RepoImplClassCodeBuilder = RepoImplClassCodeBuilder(),
    ...
    override fun replaceReferencedClasses(replaceRule: Map<KotlinClass, KotlinClass>): RepoImplClass {
