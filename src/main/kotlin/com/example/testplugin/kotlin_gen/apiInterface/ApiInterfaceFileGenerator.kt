...
class ApiInterfaceFileGenerator {

    fun generateApiInterfaceFile(
        packageDeclare: String,
        fileName: String,
        baseResponseClass: DataClass,
        project: Project?,
        psiFileFactory: PsiFileFactory,
        directory: PsiDirectory,
    ): KotlinClass {
        val fileNamesWithoutSuffix = currentDirExistsFileNamesWithoutKTSuffix(directory)
        var kotlinClassForGenerateFile = ApiInterfaceMaker(fileName,baseResponseClass as DataClass).makeKotlinClass()
